...
namespace BibleBot.Backend.Controllers.CommandGroups
{
                                        ...
                                        SpecialVerseProcessingService specialVerseProcessingService, IStringLocalizerFactory localizerFactory) : CommandGroup
    {
        ...
        private class DailyVerseSet(GuildService guildService, IStringLocalizer localizer) : Command
        {
            ...
            public override async Task<IResponse> ProcessCommand(Request req, List<string> args)
            {
                ...
                try
                {
                    ...
                    if ((hour is > -1 and < 24 || minute is > -1 and < 60) && DateTimeZoneProviders.Tzdb.GetZoneOrNull(args[1]) != null)
                    {
                        Guild idealGuild = await guildService.Get(req.GuildId);
        ...
        private class DailyVerseRole(GuildService guildService, IStringLocalizer localizer) : Command
        {
        ...
        private class DailyVerseStatus(GuildService guildService, IStringLocalizer localizer) : Command
        {
        ...
        private class DailyVerseClear(GuildService guildService, IStringLocalizer localizer) : Command
        {
