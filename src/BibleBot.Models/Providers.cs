...
{
    /// <summary>
    /// An interface that describes the implementation of a ContentProvider.
    /// </summary>
    public interface IContentProvider
    {
        ...
        Task<VerseResult> GetVerse(Reference reference, bool titlesEnabled);
        ...
        /// <returns>If the <see cref="Reference"/> is valid, a <see cref="VerseResult"/> object populated with content according to the parameters given. If not, null.</returns>
        [Obsolete("This method is deprecated and will be eventually removed. Use GetVerse(Reference, bool) instead.")]
        ...
        /// </returns>
        Task<VerseResult> GetVerse(string reference, bool titlesEnabled, Version version);
        ...
        /// content according to the parameters given. If not, null.
        /// </returns>
        [Obsolete("This method is deprecated and will be eventually removed. Use GetVerse(string, bool, Version) instead.")]
    ...
    /// <summary>
    /// An interface that describes the implementation of a MetadataProvider.
    /// </summary>
